...
# Packets [Chapter 2]
  ...
  # Packets [Sub-Chapter 2]
  To add Packet to Packets Repository you need to add Packet in Repository list like this {"packetname": "Name of packet", "packeturl":"Packet URL"}
  packet url needs to be url to packet Example: https://pastebin.com/raw/NeyKjMtv.
  In MainExe you need to put exe that run you app or etc.
...
# Languages [Chapter 3]
  ...
  And translate all sentences in lists.
  If you finished send it to 0skar16Tech.contact@gmail.com with Subject "Language For Installer" in time of 2 days your language will be added to app.
